...
This document mirrors the public listing for the customer-service role and keeps the role focused on customer support, order questions, and office communication.
...
The role supports parents, families, league coordinators, school contacts, and NESP staff from the Methuen office. Packing and shipping may happen occasionally during peak periods, but the primary focus is customer service.
...
- Complete light administrative tasks
...
- Able to manage several tasks during busy periods
- Comfortable working with a small office team
