...
Do not ask applicants for age, date of birth, photograph, marital status, family status, medical history, disability details, religion, race, ethnicity, gender identity, or other protected information during initial screening.
...
- Comfort with tablets and check-in systems
...
Use plain-language acknowledgements similar to the following, subject to final HR/legal review:
...
> I agree that New England Sports Photo may contact me about this application by email, phone, or text using the contact information I provided. Message and data rates may apply. I can ask to stop text messages at any time.
...
Thank you for applying to New England Sports Photo.
...
6. Work sample or portfolio review
7. Phone screen
8. Interview
9. Skills evaluation, when applicable
10. Reference check, when applicable
11. Offer approval
12. Hired / assigned
13. Future seasonal candidate
14. Not selected

## Portal Safety Requirements

- Limit accepted resume and portfolio file types.
- Scan uploads before they are opened internally.
- Store applicant files outside the public web root or enforce download authorization.
- Do not expose raw database credentials or storage paths.
