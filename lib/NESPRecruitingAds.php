...
class NESPRecruitingAds
{
    ...
    public static function getSourceOptions()
    {
        return array(
            ...
            'handshake' => 'Handshake',
            'masshire' => 'MassHire JobQuest / MassTalent',
    ...
    public static function getPlatformMatrix()
    {
        return array(
            ...
            array('platform_key' => 'handshake', 'platform' => 'Handshake', 'role_types' => 'Customer Service, photographers, and field assistant roles where school approval allows', 'cost_type' => 'Basic posting is generally free; paid promotion is separate', 'account_access' => 'Verified NESP employer account and approved school access', 'posting_method' => 'Manual posting to approved schools; no automatic publishing', 'image_dimensions' => 'Employer logo if requested; verify current school requirements', 'character_limits' => 'Use the limits shown by each approved school', 'tracking_support' => 'Yes, tracked external application link', 'application_destination' => 'Tracked NESP application link', 'campaign_status' => 'Draft only', 'renewal_date' => 'Set per school or posting expiration', 'approval_required' => 'Yes before employer verification, school access, terms, or publishing'),
            array('platform_key' => 'masshire', 'platform' => 'MassHire JobQuest / MassTalent', 'role_types' => 'Customer Service, photographers, and field assistant roles', 'cost_type' => 'Free public workforce posting', 'account_access' => 'Verified MassHire employer account', 'posting_method' => 'Manual employer posting; no automatic publishing', 'image_dimensions' => 'Employer logo if requested; verify current portal requirements', 'character_limits' => 'Use MassHire field limits shown during posting', 'tracking_support' => 'Yes, tracked external application link', 'application_destination' => 'Tracked NESP application link', 'campaign_status' => 'Draft only', 'renewal_date' => 'Set per MassHire expiration', 'approval_required' => 'Yes before employer verification, terms, or publishing'),
