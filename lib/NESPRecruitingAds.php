...
class NESPRecruitingAds
{
    ...
    public static function getPlatformMatrix()
    {
        return array(
            ...
            array('platform_key' => 'handshake', 'platform' => 'Handshake', 'role_types' => 'Customer Service, staff photographers, freelance photographers, field assistants', 'cost_type' => 'Free standard campus job posts', 'account_access' => 'Handshake employer account access', 'posting_method' => 'Manual job posting; no approved publishing integration', 'image_dimensions' => 'Logo/profile image; verify current Handshake requirements before editing a post', 'character_limits' => 'Use platform field limits shown during posting', 'tracking_support' => 'Yes, tracked NESP application link', 'application_destination' => 'Tracked NESP application link', 'campaign_status' => 'Draft only', 'renewal_date' => 'Set after posting', 'approval_required' => 'Yes before publishing or changing a live post'),
            array('platform_key' => 'masshire', 'platform' => 'MassHire JobQuest', 'role_types' => 'Customer Service, staff photographers, freelance photographers, field assistants', 'cost_type' => 'Free employer job posts', 'account_access' => 'MassHire employer account access', 'posting_method' => 'Manual posting after employer account approval; no approved publishing integration', 'image_dimensions' => 'Use platform requirements shown during posting', 'character_limits' => 'Use platform field limits shown during posting', 'tracking_support' => 'Yes, tracked NESP application link', 'application_destination' => 'Tracked NESP application link', 'campaign_status' => 'Draft only', 'renewal_date' => 'Set after posting', 'approval_required' => 'Yes before publishing or changing a live post'),
